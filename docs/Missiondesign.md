...
on-board the CubeSat.
  ...
  - Power Control and Distribution: The EPS is responsible for regulating and distributing the power collected and stored by the solar panels and batteries to other systems
